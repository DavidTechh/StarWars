        ...
        card.style.backgroundImage = `url('https://starwars-visualguide.com/assets/img/planets/${character.url.replace(/\D/g, "")}.jpg')`
          ...
          characterName.innerText = `${character.name}` 
           ...
           card.onclick = () => {
            ...
            rotationperiod.innerText = `Periodo de rotação: ${character.rotation_period}`
    
            const orbitalperiod = document.createElement("span")
            orbitalperiod.className = "character-details"
            orbitalperiod.innerText = `período orbital: ${character.orbital_period}`
    
            const diameter = document.createElement("span")
            diameter.className = "character-details"
            diameter.innerText = `Diamentro: ${character.diameter}`
